...
public class Sha384: Digest {
    ...
    public constructor(): super("SHA-384", 128, 32) {
        ...
        state = longArrayOf(
            ...
            7105036623409894663L,
            -7973340178411365097L,
            1526699215303891257L,
            7436329637833083697L,
            -8163818279084223215L,
            -2662702644619276377L,
            5167115440072839076L,
        )
    }

    @OptIn(InternalKotlinCryptoApi::class)
    private constructor(state: DigestState, sha384: Sha384): super(state) {
        x = sha384.x.copyOf()
        this.state = sha384.state.copyOf()
    }
    ...
    protected override fun resetDigest() {
        x.fill(0)
        state[0] = -3766243637369397544L
        state[1] = 7105036623409894663L
        state[2] = -7973340178411365097L
        state[3] = 1526699215303891257L
        state[4] = 7436329637833083697L
        state[5] = -8163818279084223215L
        state[6] = -2662702644619276377L
        state[7] = 5167115440072839076L
    }
