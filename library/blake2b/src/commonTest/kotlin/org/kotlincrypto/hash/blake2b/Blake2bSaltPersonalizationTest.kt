...
class Blake2bSaltPersonalizationTest {
    data class SaltPersonalizationTestVector(
        val input: String,
        val key: String,
        val salt: String,
    ...
    @Test
    fun testSaltPersonalization() {
        for (testVector in saltPersonalizationTestVectors) {
            val blake2b = Blake2b(
                key = testVector.key.hexToByteArray(),
                digestLength = testVector.outputLength,
                salt = testVector.salt.hexToByteArray(),
